...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Buku Keluar Baru</h4>
...
<label>Id Staf<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>Kode Buku<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Buku Keluar</button>
